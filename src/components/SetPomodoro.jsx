...
const SetPomodoro = () => {
    ...
    const handleChange = input => {
        ...
        switch (name) {
            case 'work': setNewTimer({ ...newTimer, work: parseInt(value) }); break;

            case 'shortBreak': setNewTimer({ ...newTimer, short: parseInt(value) }); break;

            case 'longBreak': setNewTimer({ ...newTimer, long: parseInt(value) }); break;
            default: break;
        }
    }
